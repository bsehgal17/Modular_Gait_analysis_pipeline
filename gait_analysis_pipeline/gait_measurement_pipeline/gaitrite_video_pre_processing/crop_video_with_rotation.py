...
# -------- CONFIGURATION --------
VIDEO_ROOT = Path(r"C:\Users\BhavyaSehgal\Downloads\Video_pre_preocessing\val_data")

JSON_ROOT = Path(
    r"C:\Users\BhavyaSehgal\Downloads\Video_pre_preocessing\val_data\MS_22_01_25_06\Lat"
)
...
# -------- Utility: Rotate frames if needed --------
def apply_rotation(frame):
    """
    Rotate a frame based on rotation metadata.
    Uses numpy.rot90 to rotate RGB array and rebuilds a VideoFrame.
    """
